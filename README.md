# pi-music-server
raspberry-pi-based music server with 512GB library capacity and custom housing. for listening anywhere. 
...
More Hardware if using the server as a speaker is an option:
  ...
  - HiFi Speakers
  - play/pause/back/forward buttons, volume dial

File Structure: ~/Music/Artists/Albums/
